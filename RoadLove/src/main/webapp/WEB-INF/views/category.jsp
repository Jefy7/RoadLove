...
<c:forEach  items="${categoryListModelAttribute}" var="category">
  <div class="col-lg-3">
     <div class="panel">
        ...
        <div class="boximg">
         <a href="${category.getCategoryName()}"><img src="resources/categoryimages/${category.getCategoryID()}.jpg" class="img-thumbnail"></a>
   ...
   <br>
        ...
        <span class="badge pull-right" style="background-color:teal"> </span>
      </div>
     </div>
  </div>
  </c:forEach>
